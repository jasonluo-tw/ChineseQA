...
def RNet(hdim=150, dropout=0.1, p_length=None, q_length=None, w2vec=300, char_level_embeddings=False):
    ## define variables
    H = hdim
    N = p_length
    M = q_length
    ...
    P_vecs = Input(shape=[N, W], name='Passage')
    Q_vecs = Input(shape=[M, W], name='Question')
    ...
    ## Pointer
    fake_input = GlobalMaxPooling1D()(uP)
